...
class StringPracticeTest extends StringPractice {
	...
	void testNumPunct() {
		...
		assertEquals(StringPractice.numPunct(". !"), 2);
		assertEquals(StringPractice
				.numPunct("There's always money in the banana stand."), 2);
	}
	...
	void testNumPunctStringInt() {
		...
		assertEquals(StringPractice
				.numPunct("There's always money in the banana stand.", 5), 2);
		assertEquals(StringPractice
				.numPunct("There's always money in the banana stand.", 6), 1);
	}
	...
	void testIndexOfFirstPunctString() {
		...
		assertEquals(StringPractice.indexOfFirstPunct(" !"), 1);
		assertEquals(StringPractice.indexOfFirstPunct(". !"), 0);
		assertEquals(StringPractice.indexOfFirstPunct(
				"There's always money in the banana stand."), 5);
	}
	...
	void testIndexOfFirstPunctStringInt() {
		...
		assertEquals(StringPractice.indexOfFirstPunct(
				"There's always money in the banana stand.", 0), 5);
		assertEquals(StringPractice.indexOfFirstPunct(
				"There's always money in the banana stand.", 5), 5);
		assertEquals(StringPractice.indexOfFirstPunct(
				"There's always money in the banana stand.", 6), 40);
	}
	...
	void testIndexOfLastPunct() {
		...
		assertEquals(StringPractice.indexOfLastPunct(
				"There's always money in the banana stand."), 40);
	}
	...
	void testSubstitutePunct() {
		assertEquals(StringPractice.substitutePunct("cheesy poofs"),
				"cheesy poofs");
		...
		assertEquals(StringPractice.substitutePunct(". !"), "   ");
		assertEquals(
				StringPractice.substitutePunct(
	...
	void testWithoutPunct() {
		assertEquals(StringPractice.withoutPunct("cheesy poofs"),
				"cheesy poofs");
